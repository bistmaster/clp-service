...
module.exports = {
  ...
  create: function create(data) {
    ...
    return session.run('CREATE (n: ' + LABEL + ' {name: {nameValue}, timestamp:{timestampVal}, day_ahead_forcast:{forecastVal}, real_time_measurement:{measurementVa}}) RETURN n', parameters).then(service.resolve()).catch(service.reject()).finally(service.finally(session, driver));
  },
